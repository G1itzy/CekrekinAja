...
<html lang="en">
    <head>
        ...
        <title>Rental Kamera CekrekinAja Yogyakarta</title>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
            <div class="container px-4">
                <a class="navbar-brand" href="/">Rental Kamera CekrekinAja</a>
        ...
        <footer class="py-5 bg-dark">
            <div class="container px-4"><p class="m-0 text-center text-white">&copy; 2025 Rental Kamera CekrekinAja</p></div>
        </footer>
        <!-- Bootstrap core JS-->
